...
const FolderComponent = (props: FolderProps) => {
  ...
  const handleFavoriteFolder = async (folderId: string) => {
    try {
      ...
      await axios.patch(
        `http://${process.env.REACT_APP_API_BASE_URL}/api/folder/${folderId}/favorite`,
        {},
        {
  ...
  const handleRestoreFolder = async (folderId: string, owner: string) => {
    ...
    try {
      await axios.patch(
        `http://${process.env.REACT_APP_API_BASE_URL}/api/folder/${folderId}/restore`,
        {},
        {
          withCredentials: true,
        },
  ...
  const handleDeleteFolder = async (folderId: string) => {
    try {
      await axios.delete(
        `http://${process.env.REACT_APP_API_BASE_URL}/api/folder/${folderId}/delete`,
        {
          withCredentials: true,
        },
      );
